		...
		<nav class="firstview-nav">
			<ul class="firstview-nav-list">
				<li class="firstview-nav-item">
					<a href="#ct1" class="firstview-nav-link">#01<br />中堅社員による座談会</a>
				</li>
				<li class="firstview-nav-item">
					<a href="#ct2" class="firstview-nav-link">#02<br />若手社員による座談会</a>
				</li>
				<li class="firstview-nav-item">
					<a href="#ct3" class="firstview-nav-link">#03<br />キャリア入社社員による座談会</a>
				</li>
			</ul>
		</nav>
	</div>
...
<section id="ct1" class="bg-container-crosstalk">
	<div class="crosstalk-container">
		<div class="crosstalk-content">
			<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/img_crosstalk_firstview-01.png" alt="" class="crosstalk-firstview">
...
<section id="ct2" class="bg-container-crosstalk">
	<div class="crosstalk-container">
		<div class="crosstalk-content">
			<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/img_crosstalk_firstview-02.png" alt="" class="crosstalk-firstview">
			<ul class="crosstalk-introduce-list">
				<li class="crosstalk-introduce-item">
		...
		<div class="crosstalk-content text">
			...
			<div class="crosstalk-video-frame">
				<div class="crosstalk-video-embed">
					<iframe width="560" height="315" src="https://www.youtube.com/embed/mzJynIxknOs?si=9JlLy-fZuBrEB9KD" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
				</div>
			</div>
		</div>
	</div>
...
<section id="ct3" class="bg-container-crosstalk">
	<div class="crosstalk-container">
		<div class="crosstalk-content">
			<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/img_crosstalk_firstview-03.png" alt="" class="crosstalk-firstview">
			<ul class="crosstalk-introduce-list">
				<li class="crosstalk-introduce-item short">
					<p class="name">村中 俊公</p>
					<p class="division">東京営業第五部</p>
					<p class="joined">2024年キャリア入社</p>
				</li>
				<li class="crosstalk-introduce-item short">
		...
		<div class="crosstalk-content text">
			<h2 class="crosstalk-title">
				...
				<span class="jp">キャリア入社社員による座談会</span>
			</h2>
			...
			<div class="crosstalk-video-frame">
				<div class="crosstalk-video-embed">
					<iframe width="560" height="315" src="https://www.youtube.com/embed/8lrpP-S-jkM?si=lvC6ed6XiYz4LLCj" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
				</div>
			</div>
		</div>
	</div>
